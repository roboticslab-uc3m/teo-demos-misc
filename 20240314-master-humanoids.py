...
tts.setLanguage('en_US-lessac-medium')
...
tts.setLanguage('es_ES-davefx-medium')
...
sayAndWait('si queréis que os deje salir, deberéis averiguar la respuesta a una serie de preguntas')
sleep(1.0)
...
sayAndWait('tenéis razón, es verdad, los investigadores de roboticslab me hacen de todo')
...
sayAndWait('juan, me rindo, puedes soltarles')
