...
helloRA1 = [-56.0, 12.9, 21.8, -99.6, 33.5, -26.1]
helloRA2 = [-59.6, 12.9, 21.8, -83.6, 33.5, -17.6]

myLA = [-24.5, 13.9, -51.6, -72.3, 0.0, 0.0]
myRA = [-55.0, -5.0, 57.0, -99.6, -56.5, 6.7]

nameLA = [-35.0, 5.0, -43.0, -85.0, 0.0, 1.8]
nameRA1 = [-65.0, 0.0, 50.0, -99.6, -20.0, 6.7]
nameRA2 = [-55.0, 2.0, 57.0, -80.0, -30.0, 15.0]
nameLH = [40.0, 2.0, 0.0, 0.0, 20.0, 20.0]
nameRH = [40.0, 2.0, 0.0, 0.0, 20.0, 20.0]

letterTA = [-73.2, 10.7, 10.6, -74.6, 34.7, 1.9]
letterTH = [57.3, 5.4, 14.9, 4.7, 1.5, 0.0]

letterEA = [-75.4, 12.4, 9.6, -83.5, 86.2, 2.3]
letterEH = [0.0, 0.0, 20.0, 20.0, 20.0, 20.0]
